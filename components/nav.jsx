...
export default function Nav() {
    return(
      <>
        ...
        <label for="menu-control" className={styles.hamburger}>
            <i className={styles.hamburger__icon}></i>
            <i className={styles.hamburger__icon}></i>
            <i className={styles.hamburger__icon}></i>
        </label>
        <label for="menu-control"><p className={styles.menu}>Menu</p></label>
    </div>

    <div>
      <Link href="/"className={styles.acceuil}>Acceuil</Link>
    </div>
    <div>
    <Link href="/a-propos"className={styles.aprop}>A propos</Link>
    </div>
    <div>
      <Link href="/contact"className={styles.contact}>Contact</Link>
    </div>
    <div>
    <Link href="/echantillon"className={styles.echan}>Échantillon</Link>
    </div>
    <div>
    <Link href="/realisation"className={styles.rea}>Réalisation</Link>
    </div>
    <div className={styles.menuimage}>
        <Link href="/"><Image src={logo} className={styles.logo} width={70}/></Link>
        <p className={styles.menulogon}>Le créateur de vos envies</p>
    </div>
    <input type="checkbox" id="menu-control" className={styles.menucontrol}/>
    
    <aside className={styles.sidebar}>
      <nav className={styles.sidebar__menu}>
        <Link href="./cuisine" alt="Kitchen">Cuisines</Link>
        <Link href="./dressing">Dressings</Link>
        <Link href="./sallesdebain">Meubles salles de bains</Link>
        <Link href="./portes">Portes</Link>
        <Link href="/realitation"className={styles.responsive}>Réalisation</Link>
        <Link href="/echantillon"className={styles.responsive}>Échantillon</Link>
        <Link href="/a-propos"className={styles.responsive}>A propos</Link>
        <Link href="/contact"className={styles.responsive}>Contact</Link>
      </nav>
      
      <label for="menu-control" className={styles.sidebar__close}></label>
