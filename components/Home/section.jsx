    ...
    return(
        <div className={styles.section}>
            <div className={styles.section1}>
                ...
                <Link href="cuisine" className={styles.btn}>VOIR LES MODÈLES</Link>
            </div>
            <div className={styles.section2}>
                ...
                <Link href="dressing" className={styles.btn2}>VOIR LES MODÈLES</Link>
            </div>
            <div className={styles.section2}>
                ...
                <Link href="sallesdebain" className={styles.btn2}>VOIR LES MODÈLES</Link>
            </div>
            <div className={styles.section2}>
                ...
                <Link href="separation" className={styles.btn2}>VOIR LES MODÈLES</Link>
            </div>
            <div className={styles.section2}>
                ...
                <Link href="accessoires" className={styles.btn2}>VOIR LES MODÈLES</Link>
            </div>
        </div>
    )
}